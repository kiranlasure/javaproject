...
.style38 {font-family: Arial, Helvetica, sans-serif; font-size: small; }
...
<table width="80%" border="0" align="center">
  <tr>
    <td bgcolor="#FF6633"><span class="style27">HR ID:<%=session.getAttribute("myuser")%>&nbsp;&nbsp;&nbsp;&nbsp;Last Login:<%=session.getAttribute("date")%> </span></td>
  </tr>
</table>
<table width="80%" align="center" bordercolor="#FFCCCC">
  <tr>
    ...
    <td height="417" align="center" valign="top" bgcolor="#FFCC99"><p align="center" class="style28">Add New Project </p>
      <hr />
      <form id="form1" name="form1" method="post" action="hraddprojectjsp.jsp">
        <div align="center">
          <table width="96%" height="43" border="0">
            <tr bgcolor="#3399FF">
              <td width="10%"><div align="center" class="style38">Project ID </div></td>
              <td width="16%"><div align="center" class="style38">Project Name </div></td>
              <td width="15%"><div align="center" class="style38">Project Type </div></td>
              <td width="9%"><div align="center" class="style38">Team length </div></td>
              <td width="14%"><div align="center" class="style38">Start Date </div></td>
              <td width="14%"><div align="center" class="style38">Due Date </div></td>
              <td width="11%"><div align="center" class="style38">Duration</div></td>
            </tr>
			<%
			Class.forName("com.mysql.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hr","root","");

			PreparedStatement pst=con.prepareStatement("select * from admin_addnewproject");
			...
			<tr bgcolor="#CCFF99"><td><div align="center" class="style38">
			  <div align="left">
			    <input type="checkbox" name="c1" value="<%=rs.getInt(1)%>" >
			    &nbsp;&nbsp;
			      <%=rs.getInt(1)%></div>
			</div></td>
			<td><div align="center" class="style38"><%=rs.getString(3)%></div></td>
			<td><div align="center" class="style38"><%=rs.getString(4)%></div></td>
			<td><div align="center" class="style38"><%=rs.getString(5)%></div></td>
			<td><div align="center" class="style38"><%=rs.getString(6)%></div></td>
			<td><div align="center" class="style38"><%=rs.getString(7)%></div></td>
			<td><div align="center" class="style38"><%=rs.getString(8)%></div></td>
			</tr>
			<%
