...
<table width="80%" align="center" bordercolor="#FFCCCC">
  <tr>
    ...
    <p><img src="inb.jpg" width="225" height="64" /></p></td>
    <td height="417" align="center" valign="top" bgcolor="#FFCC99"><p align="center" class="style28">Add New Employee </p>
      <hr />
      <form id="form1" name="form1" method="post" action="ademp.jsp">
        <table width="67%" height="171" border="0">
        <tr>
          <td width="54%"><span class="style27">Employee Code :</span></td>
          <td width="46%"><select name="t1">
        ...
        <tr>
          <td><span class="style27">DOB :</span></td>
          <td><input type="date" name="d1">&nbsp;</td>
        </tr>
        <tr>
          <td><span class="col-xs-4 col-md-4"><span class="style27">Entry Date  :</span> &nbsp; </span></td>
          <td><input type="date" name="d2">&nbsp;</td>
        </tr>
      </table>
      <p align="center"><span class="col-xs-4 col-md-4"> &nbsp;
...
String entrydt=request.getParameter("d2");
if(eid!=""&&ename!=""&&dept!=""&&dob!=""&&entrydt!=""&&eid!=null)
{
try
{

PreparedStatement pst=con.prepareStatement("insert into hr_add_new_emp values(?,?,?,?,?)");
