...
<table width="80%" align="center">
  <tr>
    ...
    <td height="417" align="center" valign="top" bgcolor="#FFCC99"><p align="center" class="style28">Add New Project </p>
      <hr />
      <form id="form1" name="form1" method="post" action="adminaddprj.jsp">
        <table width="66%" height="257" border="0">
        <tr>
          <td width="42%"><span class="style27">Project ID : </span>&nbsp;</td>
          <td width="58%"><input type="text" name="t1"></td>
        </tr>
        <tr>
          <td><span class="style27">HR ID  :</span>&nbsp;</td>
          <td><input type="text" name="t2" width="200px;" value="Prasad.17" /></td>
        </tr>
        <tr>
          <td><span class="style27">Project Name :</span>&nbsp;&nbsp;&nbsp;</td>
          <td><input type="text" name="t3" width="200px;" /></td>
        </tr>
        <tr>
          <td><span class="style27">Project Type :&nbsp;</span></td>
          <td><select name="t4">
            <option style="color:#999999">-Select Project Type-</option>
        ...
        <tr>
          <td><span class="style27">Team Length  :</span>&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
          <td><span class="col-xs-4 col-md-4"><span class="style27">Due Date  :</span> </span></td>
...
String hid=request.getParameter("t2");
String pname=request.getParameter("t3");
String ptype=request.getParameter("t4");
String tlength=request.getParameter("t5");
String startdt=request.getParameter("d1");
String duedt=request.getParameter("d2");
String dur=request.getParameter("t6");
...
PreparedStatement pst=con.prepareStatement("insert into admin_addnewproject values(?,?,?,?,?,?,?,?)");

pst.setString(1,pid);
pst.setString(2,hid);
pst.setString(3,pname);
pst.setString(4,ptype);
pst.setString(5,tlength);
pst.setString(6,startdt);
pst.setString(7,duedt);
pst.setString(8,dur);
