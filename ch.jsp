...
<table width="80%" border="0" align="center">
  <tr>
    <td bgcolor="#FF6633"><form name="form4" class="style30" id="form4">
      Recover Your Password 
    </form>    </td>
  </tr>
</table>
<table width="80%" border="0" align="center" bordercolor="#FFFFCC">
  <tr>
    <td width="52%" height="329" valign="top" bgcolor="#FFFFCC" align="center"><form id="form1" name="form1" method="post" action="chjs.jsp">
      <p>&nbsp;</p>
      <table width="45%" height="130" border="0">
        <tr>
          <td width="43%" height="26"><span class="style30">User ID:</span></td>
          <td width="57%"><input type="text" name="t1" /></td>
        </tr>
        <tr>
          <td height="26"><span class="style30">Email:</span></td>
          <td><input type="text" name="t2" /></td>
        </tr>
      </table>
      <table width="45%" height="130" border="0">
        <tr>
          <td width="43%" height="26"><span class="style30"> Name:</span></td>
          <td width="57%"><input type="text" name="t3" /></td>
        </tr>
        <tr>
          <td height="26"><span class="style30"> DOB:</span></td>
          <td><input name="d1" type="date" /></td>
        </tr>
      </table>
      <p>
