...
<table width="80%" align="center">
  <tr>
    ...
    <td height="417" align="center" valign="top" bgcolor="#FFCC99">   <p align="center"><span class="style28">Inbox</span></p>
      <hr />
	          <table width="73%" height="71" border="0">
                <tr  bgcolor="#33CCFF">
                  <td width="53%" class="style28"><div align="center">Message</div></td>
                  <td width="47%" class="style28"><div align="center">Received</div></td>
                </tr>
				<% 
	  try
	  {
	  Object muser=session.getAttribute("empuser");
	 Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hr","root","");

	   PreparedStatement pst=con.prepareStatement("select msg,sendtime from hrmsg where to1=?");
       pst.setString(1,muser.toString());
	  ...
	  %>
	  <tr bgcolor="#FFFFCC"><td><%=rs.getString(1)%></td><td><%=rs.getString(2)%></td>
	  <%
	 }
	  }
	  catch(Exception e)
