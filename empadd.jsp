...
<table width="80%" align="center">
  <tr>
    ...
    <td height="417" align="center" valign="top" bgcolor="#FFCC99">   <p align="center" class="style28">Add New Project </p>
      <hr />
      <form id="form1" name="form1" method="post" action="empaddprojectjsp.jsp">
        <div align="center">
          <table width="96%" height="43" border="0">
			...
			PreparedStatement pst=con.prepareStatement("select * from hr_add_new_project");
            ...
            <tr bgcolor="#CCFF99">
              ...
              <td><div align="center" class="style38"><%=rs.getString(2)%></div></td>
