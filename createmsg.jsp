...
<table width="80%" align="center">
  <tr>
    <td width="25%" align="center" valign="top" bgcolor="#666666"><p><a href="ademp.html" target="_self"></a><a href="newemp.html" target="_self"></a><a href="profile.html" target="_self"></a><a href="aboutme.html" target="_self"></a><a href="createmsg.jsp" target="_self"><img src="crm.jpg" width="225" height="64" border="0" /></a></p>
    ...
    <td height="417" align="center" valign="top" bgcolor="#FFCC99">   <p align="center"><span class="style28">Create Message</span></p>
      <hr />
	        <form id="form1" name="form1" method="post" action="">
      <table width="58%" height="184" border="0">
        <tr>
          <td width="27%" height="42"><span class="style37"><span class="style38">To: </span></span></td>
          <td width="73%"><input type="text" name="t1" width="200px;" /></td>
        </tr>
        <tr>
          <td height="42"><span class="style38">Subject:</span></td>
          <td><input type="text" name="t2" width="200px;" /></td>
        </tr>
        <tr>
          <td height="92"><span class="style38">Message:</span></td>
          <td><textarea name="t3" cols="30" rows="5" placeholder="Type your message here.."></textarea></td>
        </tr>
      </table>
...
session.setAttribute("MsgDate",new java.util.Date());
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hr","root","");
 Object ss=session.getAttribute("empuser");
 Object msgdate=session.getAttribute("MsgDate");

PreparedStatement pst=con.prepareStatement("insert into createmsg values(?,?,?,?)");
 

pst.setString(1,ss.toString());
pst.setString(2,s2);
pst.setString(3,s3);
pst.setString(4,msgdate.toString());

int i=pst.executeUpdate();
if(i!=0)
{
JOptionPane.showMessageDialog(null,"Message has been send successfully..");
}
}
catch(Exception e)
{
