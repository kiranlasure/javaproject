...
<body onload="MM_preloadImages('h2.jpg','ab2.jpg','comp2.jpg','cu2.jpg','login2.jpg','ae1.jpg','vp1.jpg','lo.jpg','adp1.jpg')">
...
<table width="80%" border="0" align="center">
  <tr>
    ...
    <td><a href="adminap.jsp" target="_self"><img src="ap.jpg" name="Image8" width="100%" border="0" id="Image8" /></a><a href="company.html" target="_self" onmouseover="MM_swapImage('Image4','','comp2.jpg',1)" onmouseout="MM_swapImgRestore()"></a></td>
...
<table width="80%" align="center">
  <tr>
    ...
    <p><a href="prjst.html" target="_self"></a><a href="adminrmv.jsp" target="_self"><img src="re.jpg" width="225" height="64" border="0" /></a></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p class="style32"><a href="adminchangepass.jsp" target="_self" class="style45">Change Password </a></p>    </td>
    <td height="411" align="center" valign="top" bgcolor="#FFCC99">   <p align="center" class="style27">Change Password </p>
      <hr /> 
      <form id="form1" name="form1" method="post" action="adminchangepass.jsp">
        <table width="55%" height="151" border="0">
          <tr>
            ...
            <td width="43%"><input type="password" name="t1" />            </td>
          </tr>
          <tr>
...
Object u=session.getAttribute("myuser");
...
PreparedStatement pst=con.prepareStatement("update mylogin set password=? where user=? ");
